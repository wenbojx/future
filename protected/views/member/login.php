...
<div class="detail">
    ...
    <div class="mini-layout">
        ...
        <div class="span12">
                ...
                <br>
                <form method="post" class="form-horizontal" id="member_login" action="<?=$this->createUrl('/member/register/reg');?>">
                    <fieldset>
                        <legend>用户登陆</legend>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <p class="help-block"><span id="reg_tip_passwd" style="color_red"></span></p>
                            </div>
                        </div>
